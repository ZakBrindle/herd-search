...
const SupportSystem = ({ currentUser, isDev = false, visible, onClose, isModal = true }: SupportSystemProps) => {
    ...
    const content = (
        <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%', background: isModal ? 'transparent' : '#121212', color: '#fff' }}>
            {/* Header */}
            <div className="modal-header" style={{ height: '60px', padding: '0 1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #333' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    {!isModal && (
                        <a href="/" className="btn btn-secondary" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }}>Exit Dashboard</a>
                    )}
