      ...
      <div className={styles.container}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 32 }}>
          ...
          >
            ...
            <div className="gsi-material-button-content-wrapper" style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
              <div className="gsi-material-button-icon" style={{ marginLeft: 12, marginRight: 8 }}>
              ...
              <span className="gsi-material-button-contents" style={{ fontWeight: 500, fontSize: '1rem', color: '#3c4043', flex: 1, textAlign: 'center' }}>
